...
public class PlayParSeqImplTest {
  ...
  public void setUp() {
    ...
    _playParSeqImpl = new PlayParSeqImpl(_engine, mock(ParSeqTaskStore.class), when(mock(HttpExecutionContext.class).current()).thenReturn(ForkJoinPool.commonPool()).getMock());
